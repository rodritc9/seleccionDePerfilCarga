...
**
** Created: Tue 8. Nov 12:03:34 2016
...
static const char qt_meta_stringdata_Configuracion[] = {
    "Configuracion\0\0configurar()\0"
};
...
const QMetaObjectExtraData Configuracion::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Configuracion::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Configuracion,
      qt_meta_data_Configuracion, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Configuracion::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Configuracion))
